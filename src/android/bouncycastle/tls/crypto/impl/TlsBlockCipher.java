    ...
    implements TlsCipher
{
        ...
        TlsBlockCipherImpl decryptCipher, TlsHMAC clientMac, TlsHMAC serverMac, int cipherKeySize) throws IOException
    {
        ...
        this.decryptUseInnerPlaintext = !ArrayUtil.isNullOrEmpty(decryptConnectionID);
        this.encryptUseInnerPlaintext = !ArrayUtil.isNullOrEmpty(encryptConnectionID);
    ...
    private int chooseExtraPadBlocks(int max)
    {
        ...
        int n = Integer.numberOfTrailingZeros(x);
