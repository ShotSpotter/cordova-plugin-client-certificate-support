       ...
       extends FipsParameters
   {
        ...
        extends FipsSymmetricOperatorFactory<Parameters>
    {
            ...
            implements OperatorUsingSecureRandom<OutputEncryptor<Parameters>>
        {
            ...
            {
                if (CryptoServicesRegistrar.isInApprovedOnlyMode() && !Properties.isOverrideSet("org.bouncycastle.tripledes.allow_enc"))
                {
        ...
        extends FipsKeyWrapOperatorFactory<WrapParameters, SymmetricKey>
    {
        ...
        {
            if (CryptoServicesRegistrar.isInApprovedOnlyMode() && !Properties.isOverrideSet("org.bouncycastle.tripledes.allow_wrap"))
            {
